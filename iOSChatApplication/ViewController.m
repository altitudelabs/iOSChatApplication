...
- (void)viewDidLoad {
    ...
    UINib *outgoingNib = [UINib nibWithNibName:NSStringFromClass([ChatroomOutgoingTableViewCell class]) bundle:nil];
    [self.tableViewMessageList registerNib:outgoingNib forCellReuseIdentifier:outgoingCellIdentifier];
    UINib *incomingNib = [UINib nibWithNibName:NSStringFromClass([ChatroomIncomingTableViewCell class]) bundle:nil];
    [self.tableViewMessageList registerNib:incomingNib forCellReuseIdentifier:incomingCellIdentifier];
...
- (IBAction)sendButtonTouchUpInside:(id)sender {
    ...
    Message *message = [Message initWithContent:text isOutgoing:YES];
...
- (NSMutableArray *)createDummyMessageList {
    ...
    [result addObject:[Message initWithContent:@"Yo" isOutgoing:NO]];
    [result addObject:[Message initWithContent:@"Whatsup" isOutgoing:NO]];
